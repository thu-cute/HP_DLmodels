...
import random
from .CNN_MNIST_Train import *

def get_chart_data(request):
  # epochs_range = list(range(1, 20))  # 50 epochs
  # train_loss = [random.uniform(0.2, 0.6) for _ in epochs_range]
  # test_loss = [random.uniform(0.2, 0.6) for _ in epochs_range]
  # train_accuracy = [100*random.uniform(0.75, 0.95) for _ in epochs_range]
  # test_accuracy = [100*random.uniform(0.75, 0.95) for _ in epochs_range]
